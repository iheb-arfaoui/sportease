...
public class UpdateEvenementController {
    ...
    private  final ServiceR serrec = new ServiceR();
    ...
    public void initialize() throws SQLException {
        ...
        ObservableList<Categorie> equipments = FXCollections.observableArrayList(serrec.readAll());
        cbCategorie.setItems(equipments);
        cbCategorie.valueProperty().addListener((obs, oldVal, newVal) -> {
            if (currentEvenement != null) {
                currentEvenement.setCategorie(newVal);
            }
        });
    ...
    void updateE(ActionEvent event) throws SQLException {
        ...
        Categorie selectedEquipement = cbCategorie.getValue();
        System.out.println("aaaaaaaaaaaaa"+ selectedEquipement);
        currentEvenement.setCategorie(selectedEquipement);
    ...
    public void setEvent(Evenement e) {
        ...
        if (e != null) {
            ...
            System.out.println("sqdqsssssssss" + e.getCategorie());
            cbCategorie.getSelectionModel().select(e.getCategorie());


        }
    }
    private String generateQRCodeData(String nomEvent, String lieu, Date dateEvent, int duree, Categorie selectedCategorie) {
