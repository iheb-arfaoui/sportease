...
public class ListeEvenementController implements Initializable {
    ...
    @FXML
    private TableView<Evenement> viewtable;
    @FXML
    ...
    public class QRCodeGenerator {
        public static Image generateQRCode(Evenement evenement) {
            String eventData = "id: " + evenement.getId() + " ,Nom: " + evenement.getNomEvent() + ", Date:" + evenement.getDateEvent() + ", Duree: " + evenement.getDuree() + ", Lieu: " + evenement.getLieu() + "." ;
            Map<EncodeHintType, Object> hints = new HashMap<>();
            hints.put(EncodeHintType.CHARACTER_SET, "UTF-8");
            try {
                BitMatrix bitMatrix = new QRCodeWriter().encode(eventData, BarcodeFormat.QR_CODE, 250, 250, hints);
        ...
        public static void displayQRCode(Evenement evenement, ImageView imageView) {
            Image qrImage = generateQRCode(evenement);
        ...
        qrCodeColumn.setCellFactory(column -> new TableCell<Evenement, String>() {
            ...
            protected void updateItem(String item, boolean empty) {
                ...
                if (empty || item == null) {
                    ...
                    imageView.setFitHeight(100); // Adjust size as needed
    ...
    public ObservableList<Evenement> getEvents() throws SQLException {
        ...
        String sql = "SELECT e.*, r.* FROM Evenement e LEFT JOIN categorie r ON e.id_categorie = r.id";
    ...
    private void getUpdateView(MouseEvent event) {
        ...
        if (selectedEvent != null) {
            try {
                ...
                qrCodeGenerator.displayQRCode(selectedEvent, qrCodeImageView); // Afficher le code QR du nouveau billet sélectionné
    ...
    private Evenement onEdit() {
        if (events_table.getSelectionModel().getSelectedItem() != null) {
            ...
            try {
                ...
                // Fetch the complete Evenement details by ID, including Categorie
    ...
    @FXML
    private void getWeatherView(ActionEvent event) {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/Weather.fxml"));
