...
public class AjouterEvenementController {
    ...
    void ajouterEvenement(ActionEvent event) throws ParseException {
        ...
        if (selectedDate != null) {
            ...
            String qrCodeData = generateQRCodeData(nomEvent, lieu, dateEvent, duree, selectedCategorie);
            String qrCodeImage = generateQRCode(qrCodeData);

            // Create the Evenement object with all details including the QR code
            Evenement evenement = new Evenement(nomEvent, lieu, dateEvent, duree, selectedCategorie, qrCodeImage);
