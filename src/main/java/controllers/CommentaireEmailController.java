...
*/
    ...
    void envoyerMail(ActionEvent event) {
        ...
        String port = "587"; // Remplacer par le port SMTP approprié
        String username = "arfaouimediheb@gmail.com"; // Remplacer par votre nom d'utilisateur SMTP
        String password = "jund ulnf uard spyj"; // Remplacer par votre mot de passe SMTP
    ...
    @FXML
    void retour1(ActionEvent event) throws IOException {
